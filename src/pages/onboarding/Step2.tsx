...
import { getGeneralQuestions } from '../../data/industries';
import { useOnboarding } from '../../context/OnboardingContext';
import { useAuth } from '../../context/AuthContext';
import { ComplianceResponse, ComplianceQuestion } from '../../types';
...
const Step2: React.FC = () => {
  ...
  const loadQuestions = async () => {
    try {
      setIsLoading(true);
      const fetchedQuestions = await getGeneralQuestions();
  ...
  const handleContinue = async () => {
    ...
    await updateGeneralResponses(formattedResponses);
    nextStep();
  };
